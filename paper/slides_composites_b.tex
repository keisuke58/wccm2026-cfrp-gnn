...
\begin{frame}{A2 --- Decision rule and launch economics}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \centering\includegraphics[width=\textwidth]{cost_calibration.pdf}
    \end{column}
...
\begin{frame}{A5 --- Fast surrogate + trust gate}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \centering\includegraphics[width=\textwidth]{crack_surrogate.pdf}\\
      \footnotesize FNO: field rel-$L_2$ $3.5\%$, grow-flag $0.988$, \textbf{142$\times$} speed.
    \end{column}
    \begin{column}{0.5\textwidth}
      \centering\includegraphics[width=\textwidth]{conformal_surrogate.pdf}\\
...
\begin{frame}{A6 --- Structure-agnostic surrogate: details}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \centering\includegraphics[width=\textwidth]{structure_agnostic_loso.pdf}
    \end{column}
...
\begin{frame}{A7 --- Torsion shaft: CGAX screen + 3-D explicit CZM}
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.5\textwidth}
      \centering\includegraphics[width=\textwidth]{shaft_explicit_debond.pdf}\\
...
\begin{frame}{A8 --- SRB-3 acoustic-emission detection (real data)}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \centering\includegraphics[width=\textwidth]{srb3_motorcase.pdf}
    \end{column}
...
\begin{frame}{A9 --- Sim-to-real domain adaptation: details}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \centering\includegraphics[width=\textwidth]{tsa_sim2real.pdf}\\
      \footnotesize Interstage TSA: proxy-$\mathcal A$ $2.0\!\to\!0.3$ ($97\%$ closed).
    \end{column}
    \begin{column}{0.5\textwidth}
      \centering\includegraphics[width=\textwidth]{payload_da_longterm.pdf}\\
...
\begin{frame}{A10 --- End-to-end decision UQ: error decomposition}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \centering\includegraphics[width=\textwidth]{decision_uq.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}\footnotesize
...
\begin{frame}{A11 --- Solver verification and robustness}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \centering\includegraphics[width=\textwidth]{physics_validation.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}\footnotesize
      \begin{itemize}
...
\begin{frame}{A12 --- Stage-4 hierarchical fleet learning}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \centering\includegraphics[width=\textwidth]{fleet_learning.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}\footnotesize
...
\begin{frame}{A13 --- Stage-5 multi-objective design (Pareto)}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \centering\includegraphics[width=\textwidth]{design_feedback_pareto.pdf}
    \end{column}
    \begin{column}{0.45\textwidth}\footnotesize
...
\begin{frame}{A14 --- Differentiable inversion (Keio bridge)}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \centering\includegraphics[width=\textwidth]{diff_inversion.pdf}
    \end{column}
    \begin{column}{0.5\textwidth}\footnotesize
