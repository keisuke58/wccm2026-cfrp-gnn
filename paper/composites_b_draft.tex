...
\emph{overconfident} (ECE $0.18$, Fig.~\ref{fig:decuq}d), since sampling spread
alone misses the surrogate's systematic bias --- an honest pointer to
decision-level conformal recalibration.
\begin{figure}[t]\centering
