...
\begin{column}{0.45\textwidth}
  \centering
  \includegraphics[width=\linewidth]{noise_defect_0.png}\\
  {\scriptsize Original vs.\ noise-injected DSPSS input.}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{ndf_make_0.png}\\
  {\scriptsize Defect-free noised samples teach the model what ``no defect'' looks like.}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{noise_pred_0.png}\\
  {\scriptsize Prediction on noisy input.}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{diff_calc_0.png}\\
  {\scriptsize Original $-$ reference $=$ difference field.}
\end{column}
\end{columns}
\end{frame}
