...
\end{itemize}
\vspace{0.2em}
\begin{center}\includegraphics[width=0.84\linewidth]{prior_cnn_gnn.png}\end{center}
\vspace{-0.3em}{\centering\scriptsize The FEM mesh is naturally a graph; a GNN handles the hole-perforated topology a CNN grid cannot.\par}
\end{frame}
